...
public class TestSparseManipulations {
	...
	public void testMatrixEmptyArray() {
		try {
			new SparseManipulations(new int[][] {});
		} catch (Exception e) {
	...
	public void testMatrixAdditionDifferentSizedMatrices() {
		try {
			SparseManipulations mo = new SparseManipulations(new int[][] { { 2, 3 }, { 5, 6 }, { 6, 9 } });
			SparseManipulations mo1 = new SparseManipulations(new int[][] { { 2, 2, 2, 2 }, { 2, 2, 2, 2 } });
			mo.addMatrix(mo, mo1);
		} catch (Exception e) {
	...
	public void testMatrixNullValuePassedForAddition() {
		try {
			new SparseManipulations(new int[][] { { 1, 2 }, { 2, 1 } }).addMatrix(null, null);
		} catch (Exception e) {
	...
	public void test_addMatrix() throws Exception{
		SparseManipulations mo = new SparseManipulations(new int[][] { { 2, 3 }, { 5, 6 }, { 6, 9 } });
		SparseManipulations mo1 = new SparseManipulations(new int[][] { { 2, 2 }, { 2, 2 }, { 2, 2 } });
	...
	public void testMatrixMultiplicationDifferentSizedMatrices() {
		try {
			SparseManipulations mo = new SparseManipulations(new int[][] { { 1, 2, 3 }, { 4, 5, 6 }, { 7, 8, 9 } });
			SparseManipulations mo1 = new SparseManipulations(new int[][] { { 2, 2, 2, 2 }, { 2, 2, 2, 2 } });
	...
	public void testMatrixNullValuePassedForMultiplication() {
		try {
			new SparseManipulations(new int[][] { { 1, 2 }, { 2, 1 } }).multiplyMatrix(null, null);
		} catch (Exception e) {
			assertEquals(" NUll Value Object Passed", e.getMessage());
		}
	}
	...
	public void testSymmetricMatrix_positive()throws Exception{
		SparseManipulations mo = new SparseManipulations(new int[][] { { 1, 2, 3 }, { 2, 5, 4 }, { 3, 4, 9 } });
	...
	public void testSymmetricMatrix_Negative_Row_Column_Not_Same() throws Exception {
		SparseManipulations mo = new SparseManipulations(new int[][] { { 2, 3 }, { 5, 4 }, { 4, 9 } });
	...
	public void testSymmetricMatrix_Negative()throws Exception{
		SparseManipulations mo = new SparseManipulations(new int[][] { { 2, 3, 1 }, { 5, 4, 6 }, { 7, 8, 9 } });
		assertFalse(mo.isSymmetric());
	}
