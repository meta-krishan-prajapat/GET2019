package SFC_Module1_Assign;

import java.util.*;

/**
 * @author krishan Items class have the Items of catalogue
 */
class Items {
...
/**
 * @author krishan ShoppingCart class is created to perform cart operations
...
public class ShoppingCart extends Items {
	...
	/**
	 * @param input is used to select the particular operation to perform
	 */
	...
	public void changeItemquantity() {
		...
		try {
			if (cartItems.isEmpty()) {
				...
				System.out.println("enter id of the item for which you want to change quanty");
				scanner = new Scanner(System.in);
				String id = scanner.next();
